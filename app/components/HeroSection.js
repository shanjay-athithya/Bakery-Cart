      ...
      <div className="absolute inset-0 flex items-center justify-center z-20 text-center">
        <div className="text-center px-4">
          ...
          <button
            ...
            className="px-8 py-4 bg-pastelYellow text-white rounded-full shadow-lg transition-transform transform hover:scale-110 focus:outline-none focus:ring-4 focus:ring-pastelPink focus:ring-opacity-50"
          >
            View Menu
          </button>
        </div>
